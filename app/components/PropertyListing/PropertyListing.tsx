  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="flex flex-col justify-center items-center -mt-[8rem] ">
        <div className="xl:w-[1019px] lg:w-[800px] md:w-[520px]  lg:h-[117px] md:h-[90px] z-40 h-[80px] bg-white shadow-lg rounded-lg flex items-center justify-evenly gap-2 px-2">
          ...
          <select
            ...
            className="w-full md:w-auto border border-gray-300 rounded-md py-2 px-4"
          >
            <option value="">400sqft - 500sqft</option>
            <option value="Port Harcourt">500sqft - 1000sqft</option>
            <option value="Lagos">1000sqft - 1500sqft</option>
            <option value="Abuja">1500sqft - 2000sqft</option>
          </select>
          ...
          <select
            ...
            className="w-full md:w-auto border border-gray-300 rounded-md py-2 px-4"
          >
            <option value="">N100,000 - 200,000</option>
            <option value="Port Harcourt">N200,000 - N300,000</option>
            <option value="Lagos">N400,000 - N500,000</option>
            <option value="Abuja">N600,000 - N700,000</option>
          </select>
        ...
        {/* Search button */}
        <div
          className="flex gap-3 bg-primary xl:w-[175px] md:w-[120px] z-40  w-[100px] xl:h-[40px] md:h-[40px] h-[35px] transition duration-200 rounded-lg items-center justify-center -mt-4 xl:-mt-5 md:-mt-5 "
          ...
          >
            ...
            <div className="card-body mx-5 mt-5">
              ...
              <div className="mt-2 flex justify-between">
                <p className="text-black font-semibold ">N{property.budget}</p>
      ...
      <div className="flex justify-center items-center gap-[4rem] my-[7rem] wrapper">
        ...
        <Link href="/services">
          <button className=" w-[353px] h-[83px] border-[1px] rounded-lg border-primary text-primary text-base font-semibold bg-white hover:bg-primary hover:text-white">
